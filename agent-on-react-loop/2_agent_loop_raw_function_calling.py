...
tools_for_llm = [
    {
        ...
        "function" : {
        "name": "apply_discount",
        "description": "Apply a discount tier to a price and return the final price. Available tires: bronze, silver, gold.",
        "parameters": {
            "type": "object",
            "properties": {
                "price": {
                ...
                "discount_tier": {
                    "type": "string",
                    "description": "The discount tire: 'bronze', 'silver', 'gold'"
                }
            },
            "required": ["product"]
        }
...
@traceable(name="Ollama", run_type="llm")
